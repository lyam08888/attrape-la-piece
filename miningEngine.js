...
const BLOCK_BREAK_TIME = {
    ...
    // === TUILES RPG AVANCÉES ===
    // Paradis
    [TILE.DIVINE_STONE]: 4.5,
    [TILE.BLESSED_EARTH]: 1.0,
    [TILE.CELESTIAL_CRYSTAL]: 6.0,
    [TILE.HOLY_WATER]: 0.3,
    [TILE.ANGEL_FEATHER]: 0.2,
    [TILE.DIVINE_GOLD]: 5.0,
    [TILE.PARADISE_FLOWER]: 0.1,
    [TILE.LIGHT_CRYSTAL]: 3.5,
    [TILE.SACRED_TREE]: 2.0,
    [TILE.HEAVENLY_CLOUD]: 0.1,
    
    // Forêt Enchantée
    [TILE.ENCHANTED_WOOD]: 2.5,
    [TILE.MAGIC_LEAVES]: 0.4,
    [TILE.FAIRY_DUST]: 0.1,
    [TILE.MOONSTONE]: 4.0,
    [TILE.ELVEN_CRYSTAL]: 5.5,
    [TILE.MYSTIC_FLOWER]: 0.2,
    [TILE.ANCIENT_ROOT]: 3.0,
    [TILE.SPIRIT_MOSS]: 0.3,
    [TILE.ENCHANTED_VINE]: 0.5,
    [TILE.DRUID_STONE]: 3.5,
    
    // Cristaux
    [TILE.CRYSTAL_FORMATION]: 4.0,
    [TILE.PURE_CRYSTAL]: 7.0,
    [TILE.RESONANT_CRYSTAL]: 6.5,
    [TILE.POWER_CRYSTAL]: 8.0,
    [TILE.VOID_CRYSTAL]: 9.0,
    [TILE.CRYSTAL_CLUSTER]: 5.0,
    [TILE.PRISMATIC_CRYSTAL]: 7.5,
    [TILE.ENERGY_CRYSTAL]: 6.0,
    [TILE.TIME_CRYSTAL]: 10.0,
    [TILE.SPACE_CRYSTAL]: 12.0,
    
    // Enfer
    [TILE.INFERNAL_STONE]: 5.0,
    [TILE.LAVA_ROCK]: 3.5,
    [TILE.BRIMSTONE]: 4.0,
    [TILE.DEMON_CRYSTAL]: 8.5,
    [TILE.HELLFIRE]: 0.5,
    [TILE.MOLTEN_GOLD]: 6.0,
    [TILE.DEVIL_HORN]: 7.0,
    [TILE.SULFUR]: 2.0,
    [TILE.MAGMA_CRYSTAL]: 5.5,
    [TILE.INFERNAL_IRON]: 4.5,
    
    // Abysse
    [TILE.VOID_STONE]: 8.0,
    [TILE.SHADOW_CRYSTAL]: 9.5,
    [TILE.DARK_MATTER]: 15.0,
    [TILE.ABYSSAL_STONE]: 10.0,
    [TILE.NIGHTMARE_CRYSTAL]: 12.0,
    [TILE.VOID_ESSENCE]: 0.8,
    [TILE.SHADOW_ORE]: 7.5,
    [TILE.DARK_ENERGY]: 1.0,
    [TILE.CHAOS_CRYSTAL]: 20.0,
    [TILE.ETERNAL_DARKNESS]: 25.0
};
